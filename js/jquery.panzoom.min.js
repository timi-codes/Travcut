...
! function(a, b) {
    ...
    function g(a, c) {
        ...
        var e = this.$elem = b(a);
        this.$set = c.$set && c.$set.length ? c.$set : e, this.$doc = b(a.ownerDocument || l), this.$parent = e.parent(),
        ...
        var f = b(),
            h = this;
        b.each(["$zoomIn", "$zoomOut", "$zoomRange", "$reset"], function(a, b) { h[b] = c[b] || f }), this.enable(),
            // Save the instance
            b.data(a, m, this)
    }
    ...
    var l = a.document,
        ...
        o = !!a.PointerEvent,
        p = function() { var a = l.createElement("input"); return a.setAttribute("oninput", "return"), "function" == typeof a.oninput }(),
        q = /([A-Z])/g,
        r = /^http:[\w\.\/]+svg$/,
        s = /^inline/,
        t = "(\\-?[\\d\\.e]+)",
    ...
    return e.prototype = {
         ...
         */
        x: function(a) { var b = a instanceof f,
                c = this.elements,
         ...
         * @returns {Matrix}
         */
        inverse: function() { var a = 1 / this.determinant(),
         ...
         */
        resetZoom: function(a) { a = d(a); var b = this.getMatrix(this._origTransform);
            a.dValue = b[3], this.zoom(b[0], a) },
        /**
         * Only reset panning
         * @param {Boolean|Object} [options] Whether to animate the reset (default: true) or an object of options to pass to pan()
         */
        resetPan: function(a) { var b = this.getMatrix(this._origTransform);
        ...
        zoom: function(a, c) {
            ...
            if (!d.disableZoom) {
                ...
                "number" != typeof a && (a = +h[0] + d.increment * (a ? -1 : 1), g = !0),
                    // Constrain scale
        ...
        _setOptions: function(a) {
            b.each(a, b.proxy(function(a, c) {
                switch (a) {
                    case "disablePan":
                        this._resetStyle(); /* falls through */
                    case "$zoomIn":
                    case "$zoomOut":
                    case "$zoomRange":
                    case "$reset":
                ...
                switch (this.options[a] = c, a) {
                    ...
                    case "duration":
                    case "easing":
                        this._buildTransition(); /* falls through */
                    case "transition":
                        this.transition();
                        break;
                    case "$set":
        ...
        _bind: function() {
            ...
            if (
                ...
                b.each(["Start", "Change", "Zoom", "Pan", "End", "Reset"], function() { var a = c["on" + this];
                    b.isFunction(a) && (h["panzoom" + this.toLowerCase() + d] = a) }),
                // Bind $elem drag and click/touchdown events
                // Bind touchstart if either panning or zooming is enabled
                c.disablePan && c.disableZoom || (h[e] = function(b) { var d;
                    ("touchstart" === b.type ? !(d = b.touches) || (1 !== d.length || c.disablePan) && 2 !== d.length : c.disablePan || 1 !== b.which) || (b.preventDefault(), b.stopPropagation(), a._startMove(b, d)) }), this.$elem.on(h),
                // Bind reset
         ...
         */
        _buildTransition: function() { if (this._transform) { var a = this.options;
         ...
         */
        _getDistance: function(a) { var b = a[0],
         ...
         */
        _getMiddle: function(a) { var b = a[0],
        ...
        _startMove: function(a, d) {
            ...
            // Use proper events
            o ? (f = "pointermove", g = "pointerup") : "touchstart" === a.type ? (f = "touchmove", g = "touchend") : (f = "mousemove", g = "mouseup"), f += q, g += q, this.transition(!0), this.panning = !0, this._trigger("start", a, d), d && 2 === d.length ? (h = this._getDistance(d), i = +r[0], j = this._getMiddle(d), e = function(a) { a.preventDefault(); var b = n._getMiddle(d = a.touches),
                    c = n._getDistance(d) - h;
                n.zoom(c * (p.increment / 100) + i, { focal: b, matrix: r, animate: !1 }), n.pan(+r[4] + b.clientX - j.clientX, +r[5] + b.clientY - j.clientY, v), j = b }) : (k = a.pageX, m = a.pageY, e = function(a) { a.preventDefault(), n.pan(t + a.pageX - k, u + a.pageY - m, v) }), b(l).off(q).on(f, e).on(g, function(a) { a.preventDefault(), b(this).off(q), n.panning = !1, a.type = "panzoomend", n._trigger(a, r, !c(r, s)) })
        }
